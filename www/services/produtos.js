app.factory("produtosService", function ($cookies, $http, $mdToast) {
    prod = {};
    prod.list = [];
    //prod.list = [
    ...
    prod.getProdutos = function () {
        $http.get('/api/produto/listar/').then(function (data) {
            prod.list = data.data;
        });
    }
    prod.getProdutos();
    ...
    prod.adicionarProduto = function (produto) {
        $http.put('/api/produto/', produto).then(function (data) {
            $mdToast.show(
                $mdToast.simple()
    ...
    prod.editarProduto = function (produto) {
        ...
        $http.post('/api/produto/', produto).then(function (data) {
            $mdToast.show(
                $mdToast.simple()
                    .textContent(data.data)
                    .position('bottom right')
